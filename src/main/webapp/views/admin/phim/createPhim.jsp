...
<br />
<div class="container">
	  <form:form modelAttribute="phim" action="/admin/phim/store" method="POST" enctype="multipart/form-data">
	  <div class="field" tabindex="1">
			<label >
				<i class="far fa-user"></i>Mã Phim
			</label>
		...
		<div class="field" tabindex="1">
			...
			<form:errors path="tenphim" class="text-danger" style="font-size:30px"></form:errors>
		</div>
