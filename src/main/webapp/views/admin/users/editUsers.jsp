...
<br />
<div class="container">
	  <form:form modelAttribute="khachhang" action="/admin/users/update/${khachhang.makh }" method="post" enctype="multipart/form-data">
	  <div class="field" tabindex="1">
		...
		<div class="field" tabindex="3">
			...
			<img src="${pageContext.request.contextPath}/images/${khachhang.anh}" style="width:120px;height:100px" />
